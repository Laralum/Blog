            ...
            <div class="uk-width-1-1@s uk-width-3-5@l uk-width-1-3@xl">
                <div class="uk-card uk-card-default">
                    <div class="uk-card-header">
                        {{ __('laralum_blog::general.edit_category') }}
                    </div>
                    <div class="uk-card-body">
                        <form class="uk-form-stacked" method="POST" action="{{ route('laralum::blog.categories.update', ['category' => $category->id]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input value="{{ old('name', $category->name) }}" name="name" class="uk-input" type="text" placeholder="@lang('laralum_blog::general.name')">
                                    </div>
                                </div>

                                <div class="uk-margin">
                                <a href="{{ route('laralum::blog.categories.index') }}" class="uk-button uk-button-default uk-align-left">@lang('laralum_blog::general.cancel')</a>
                                    <button type="submit" class="uk-button uk-button-primary uk-align-right">
                                        <span class="ion-forward"></span>&nbsp; {{ __('laralum_blog::general.edit_category') }}
                                    </button>
                                </div>
                            </fieldset>
                        </form>
