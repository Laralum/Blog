                        ...
                        <form class="uk-form-stacked" method="POST" action="{{ route('laralum::blog.posts.store') }}">
                            ...
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input value="{{ old('image') }}" name="image" id="image-url" class="uk-input" type="text" placeholder="@lang('laralum_blog::general.image_url_ph')">
                                    </div>
                                </div>
                                <div class="uk-margin">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <label><input class="uk-checkbox" type="checkbox" name="public" value="1" @can('publish', \Laralum\Blog\Models\Post::class) {{ !old('public') ?: 'checked' }} @else disabled @endif> @lang('laralum_blog::general.public')</label>
                                </div>
